...
retval = frontFaceLUT[(int)frontFace];
...
retval = imageTypeLUT[(int)imageType];
...
LV_CHECK_ARGUMENT(ImageType, imageType); \
retval = imageViewTypeLUT[(int)imageType];
...
retval = attachmentLoadOpLUT[(int)attachmentLoadOperation];
...
retval = attachmentStoreOpLUT[(int)attachmentStoreOperation];
...
retval = compareOpLUT[(int)compareOperation];
...
retval = imageLayoutLUT[(int)imageLayout];
...
retval = memoryPropertiesLUT[(int)memoryType];
...
retval = blendOpLUT[(int)blendOperation];
...
retval = descriptorTypeLUT[(int)descriptorType];
...
retval = vertexInputRateLUT[(int)vertexInputRate];
